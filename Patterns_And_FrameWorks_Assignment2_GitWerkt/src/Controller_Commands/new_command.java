...
public class new_command extends Command {
	...
	public boolean execute() {
		...
		// goods wagon: "new wagon <<WagonID>> maxweight <<NUMBER>>"
			...
			b = false;
		} else if (super.GeldigheidCommandcontrole("[a-z0-9]*", characters[2])
				|| super.GeldigheidCommandcontrole("[0-9]*", characters[4])) {
			...
			} else if (characters[3].equals("numseats") || super.GeldigheidCommandcontrole("[a-z0-9]*", characters[2])
					|| super.GeldigheidCommandcontrole("[0-9]*", characters[4])) {
